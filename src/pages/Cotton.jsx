...
const Cotton = () => {
    ...
    const rows = [
        {
            ...
            gender: "hasd",
            category: "hasd",
            quantityOfSeeds: "area",
            areaPlanted: "area",
            cottonHarvested: "area",
            variety: "area",
            remarks: "area",
        },
        {
    ...
    const columns = [
        { field: "reportDate", headerName: "Report Date", width: 200 },
        {
            ...
            headerName: "Name of Benefeciary",
            width: 200,
        },
        ...
        {
            field: "quantityOfSeeds",
            headerName: "Quantity of Cotton Seeds Given",
            type: "string",
            width: 200,
        },
        {
        ...
        {
            field: "cottonHarvested",
            headerName: "Seed Cotton Harvested",
            type: "string",
            width: 200,
        },
        {
    ...
    return (
        <PageContainer>
            <Box sx={{ display: "flex", alignItems: "center", py: 3 }}>
                <GiCottonFlower style={{ fontSize: "80px" }} />
                <Typography
                    sx={{ fontWeight: "bold", fontSize: "20px", ml: 2 }}
                >
                    COTTON PRODUCTION REPORTS (Last 2 months)
                </Typography>
            </Box>
