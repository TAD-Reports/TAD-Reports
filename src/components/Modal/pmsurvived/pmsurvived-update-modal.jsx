...
import Schema from "../../../schemas/pmsurvived-schema";
import Service from "../../../services/pmsurvived-service";

export default function PmsurvivedUpdateModal({
  open,
  onClose,
  selected,
  onSuccess,
...
PmsurvivedUpdateModal.defaultProps = {
  open: false,
  onClose: () => {},
  selected: null,
  onSuccess: () => {},
...
PmsurvivedUpdateModal.propTypes = {
  open: PropTypes.bool,
